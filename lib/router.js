...
ProjectsListController = RouteController.extend({
  template: 'allProjectsList',
  subscriptions: function() {
    this.projectsSub = Meteor.subscribe('projects');
  },
  projects: function() {
...
Router.route('/submit/project', {name: 'projectSubmit'});
...
Router.onBeforeAction(requireLogin, {only: ['postSubmit', 'userProjectsList']});
