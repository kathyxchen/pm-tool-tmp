...
/*
Projects.allow({
  update: function(userId, pm, projectUsers) { return memberInProject(userId, pm, projectUsers); },
  remove: function(userId, pm, projectUsers) { return memberInProject(userId, pm, projectUsers); },
});
*/
